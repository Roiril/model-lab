...
# --- クリアランス（片側） ---
CLR_L = 0.0005   # 長辺方向 0.5mm（側壁リブで実効 0.15mm まで詰める）
CLR_W = 0.0004   # 短辺方向 0.4mm
CLR_T = 0.0004   # 厚み方向 0.4mm（保持リブで実効 0.1mm まで詰める）
...
WIN_S_MIN    = 0.0030
WIN_S_MAX    = SLOPE_LEN   # 斜面の上端まで開く（カメラバーが引っかからない）
