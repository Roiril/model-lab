...
断面と印刷:
    ...
    穴の天井は中央の橋渡しを6mmに抑え、両側を45度で立ち上げる。
...
BORE_ROOF_HALF = 3.0                # 穴の天井に残す平らな部分の半幅。橋渡しは6mm
BORE_ROOF_TOP = BORE_D / 2 * 2**0.5 - BORE_ROOF_HALF  # 17.22。側面は45度
ROOF_SKIN_LIFT = 3.5                # 握り部の上面をなだらかに持ち上げ、天井の肉厚を保つ
