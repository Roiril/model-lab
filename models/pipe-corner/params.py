...
断面と印刷:
    半径 HUB_R の円から下面の45度接線と平底へつなぐ。下面の角は R0.8。
    本体は寝かせて刷る。位置決め舌の下面に局所サポートを付ける。
    穴の天井は従来のティアドロップを維持する。
...
抜け止め:
    突き当ては押す向きしか止めない。抜けは上からテープで巻いて止める（2026-09-14 ユーザー判断。
    一度は各腕に M4 の止めねじのボスを付けたが外した）。
